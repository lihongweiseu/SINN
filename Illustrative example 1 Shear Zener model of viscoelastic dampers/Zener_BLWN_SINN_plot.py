...
f = loadmat('Zener_BLWN_SINN_pred_2layer1_2state_2neuron1_6000_10s.mat')
...
# %% Plot the input
fig1 = plt.figure(figsize = (16 * cm, 10 * cm))
...
# ax.text(20, 7.5, 'Case 2', ha='center', va='center', fontsize=8)

ax = plt.subplot(333)
ax.set_ylim([-4, 4])
ax.set_yticks(np.arange(-4, 4.1, 2))
# ax.text(20, 3, 'Case 3', ha='center', va='center', fontsize=8)

ax = plt.subplot(334)
ax.set_ylabel(r'Disp. (mm)', fontsize = 8, labelpad = 1)
ax.set_ylim([-2, 2])
ax.set_yticks(np.arange(-2, 2.1, 1))
# ax.text(20, 1.5, 'Case 4', ha='center', va='center', fontsize=8)

ax = plt.subplot(335)
ax.set_ylim([-0.8, 0.8])
ax.set_yticks(np.arange(-0.8, 0.81, 0.4))
# ax.text(20, 0.6, 'Case 5', ha='center', va='center', fontsize=8)

ax = plt.subplot(336)
ax.set_ylim([-40, 40])
ax.set_yticks(np.arange(-40, 40.1, 20))
# ax.text(20, 30, 'Case 6', ha='center', va='center', fontsize=8)
...
# ax.text(20, 15, 'Case 7', ha='center', va='center', fontsize=8)

ax = plt.subplot(338)
ax.set_xlabel(r'Time (s)', fontsize = 8, labelpad = 1)
ax.set_ylim([-10, 10])
ax.set_yticks(np.arange(-10, 10.1, 5))
# ax.text(20, 7.5, 'Case 8', ha='center', va='center', fontsize=8)

ax = plt.subplot(339)
ax.set_xlabel(r'Time (s)', fontsize = 8, labelpad = 1)
ax.set_ylim([-6, 6])
ax.set_yticks(np.arange(-6, 6.1, 3))
# ax.text(20, 4.5, 'Case 9', ha='center', va='center', fontsize=8)
...
plt.show()
# fig1.savefig(fname = "F_Zener_BLWN_u.pdf", format = "pdf")
...
ax_list = []
fig2 = plt.figure(figsize = (16 * cm, 8 * cm))
ax_list.append(fig2.add_subplot(gs[0, :]))
ax = ax_list[0]
ax.plot(Test_data[0][0][0, :], Test_data[0][2][2, :], color = col[0], dashes = c_dash[0], lw = 0.5,
        label = 'Ground truth')
ax.plot(Test_data[0][0][0, :], Test_data[0][3][2, :], color = col[1], dashes = c_dash[1], lw = 0.5,
        label = 'Prediction')
...
plt.setp(text_box.patch, facecolor = 'white', alpha = 1, lw = .75)
ax.add_artist(text_box)
legend = ax.legend(loc = 'upper right', bbox_to_anchor = (1., 1.), borderpad = 0.2, borderaxespad = 0,
                   handlelength = 2.8,
...
ax_list.append(fig2.add_subplot(gs[1, 0]))
ax = ax_list[1]
ax.plot(Test_data[0][0][0, :], Test_data[0][2][2, :], color = col[0], dashes = c_dash[0], lw = 0.5,
        label = 'Ground truth')
ax.plot(Test_data[0][0][0, :], Test_data[0][3][2, :], color = col[1], dashes = c_dash[1], lw = 0.5,
...
ax_list.append(fig2.add_subplot(gs[1, 1]))
ax = ax_list[2]
ax.plot(Test_data[0][0][0, :], Test_data[0][2][2, :], color = col[0], dashes = c_dash[0], lw = 0.5,
        label = 'Ground truth')
ax.plot(Test_data[0][0][0, :], Test_data[0][3][2, :], color = col[1], dashes = c_dash[1], lw = 0.5,
...
# fig2.savefig(fname = "F_Zener_BLWN_case4.pdf", format = "pdf")
...
ax = ax_list[0]
ax.plot(Test_data[1][0][0, :], Test_data[1][2][0, :], color = col[0], dashes = c_dash[0], lw = 0.5,
        label = 'Ground truth')
ax.plot(Test_data[1][0][0, :], Test_data[1][3][0, :], color = col[1], dashes = c_dash[1], lw = 0.5,
        label = 'Prediction')
ax.set_ylabel(r'Force. (kN)', fontsize = 8, labelpad = 1)
ax.set_xlim([0, 100])
ax.set_xticks(np.arange(0, 100.1, 10))
...
plt.show()
# fig3.savefig(fname = "F_Zener_BLWN_case6.pdf", format = "pdf")